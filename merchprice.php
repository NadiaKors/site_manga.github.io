...
<head>
    ...
    <link rel="stylesheet" href="./css/merchpriceHeader.css">
    <link rel="stylesheet" href="./css/merchpriceContent.css">
    <link rel="stylesheet" href="./css/merchpriceFooter.css">
...
<body>
    <main>
        <div class="content">
            <div class="filtr">
                ...
                <div class="dropdown">
                    <span><h3>Издание</h3></span>
                    <ul>
                      <li><input type="checkbox" id="opt1"><label for="opt1">Российские авторы</label></li>
                      <li><input type="checkbox" id="opt1"><label for="opt1">Зарубежные авторы</label></li>
                    </ul>
                </div>
                <div>
            ...
            <div class="manga1 manga">
                <div class="slider">
                    <img src="img/banners/Округ хэрроу1.jpg" alt="" class="imgSlider1 blockSlider1">
                    <img src="img/banners/Округ хэрроу12.jpg" alt="" class="imgSlider1">
                    <img src="img/banners/Округ хэрроу3.jpg" alt="" class="imgSlider1">
                ...
                <!-- <div class="dotBlock">
                    ...
                    <a href="">Округ Хэрроу. Том 1. Бесчисленные духи</a>
                    <button class="v_korziny">В корзину</button>
            </div>
            <div class="manga2 manga">
                <div class="slider">
                    <img src="img/banners/Ключи Локков1.jpg" alt="" class="imgSlider2 blockSlider2">
                    <img src="img/banners/Ключи Локков2.jpg" alt="" class="imgSlider2">
                    <img src="img/banners/Ключи Локков3.jpg" alt="" class="imgSlider2">
                ...
                <!-- <div class="dotBlock">
                    ...
                    <a href="">Ключи Локков. Добро пожаловать в Лавкрафт</a>
                    <button class="v_korziny">В корзину</button>
            </div>
            <div class="manga3 manga">
                <div class="slider">
                    <img src="img/banners/Изгой. Книга 11.jpg" alt="" class="imgSlider3 blockSlider3">
                    <img src="img/banners/Изгой. Книга 12.jpg" alt="" class="imgSlider3">
                    <img src="img/banners/Изгой. Книга 13.jpeg" alt="" class="imgSlider3">
                ...
                <!-- <div class="dotBlock">
                    ...
                    <a href="">Изгой. Книга 1: Его окружает тьма</a>
                    <button class="v_korziny">В корзину</button>
            </div>
            <div class="manga4 manga">
                <div class="slider">
                    <img src="img/banners/Ведьмы1.jpg" alt="" class="imgSlider4 blockSlider4">
                    <img src="img/banners/Ведьмы2.jpg" alt="" class="imgSlider4">
                    <img src="img/banners/Ведьмы1.jpg alt="" class="imgSlider4">
                ...
                <!-- <div class="dotBlock">
                    ...
                    <a href="">Ведьмы. Том 1 </a>
                    <button class="v_korziny">В корзину</button>
            </div>
            <div class="manga5 manga">
                <div class="slider">
                    <img src="img/banners/Загробная жизнь с Арчи1.jpg" alt="" class="imgSlider5 blockSlider5">
                    <img src="img/banners/Загробная жизнь с Арчи2.jpg" alt="" class="imgSlider5">
                    <img src="img/banners/Загробная жизнь с Арчи3.jpg" alt="" class="imgSlider5">
                ...
                <!-- <div class="dotBlock">
                    ...
                    <a href="">Загробная жизнь с Арчи</a>
                    <button class="v_korziny">В корзину</button>
            </div>
            <div class="manga6 manga">
                <div class="slider">
                    <img src="img/banners/БРПД19461.jpg" alt="" class="imgSlider6 blockSlider6">
                    <img src="img/banners/БРПД19462.jpg" alt="" class="imgSlider6">
                    <img src="img/banners/БРПД19463.jpg" alt="" class="imgSlider6">
            ...
            <div class="manga7 manga">
                <div class="slider">
                    <img src="img/banners/История с кладбищем1.jpg" alt="" class="imgSlider7 blockSlider7">
                    <img src="img/banners/История с кладбищем2.jpg" alt="" class="imgSlider7">
                    <img src="img/banners/История с кладбищем1.jpg" alt="" class="imgSlider7">
                ...
                <!-- <div class="dotBlock">
                    ...
                    <a href="">История с кладбищем</a>
                    <button class="v_korziny">В корзину</button>
            </div>
            <div class="manga8 manga">
                <div class="slider">
                    <img src="img/banners/Кромвель Стоун1.jpg" alt="" class="imgSlider8 blockSlider8">
                    <img src="img/banners/Кромвель Стоун2.jpg" alt="" class="imgSlider8">
                    <img src="img/banners/Кромвель Стоун3.jpg" alt="" class="imgSlider8">
                ...
                <!-- <div class="dotBlock">
                    ...
                    <a href="">Кромвель Стоун</a>
                    <button class="v_korziny">В корзину</button>
            </div>
            <div class="manga9 manga">
                <div class="slider">
                    <img src="img/banners/Коралина1.jpg" alt="" class="imgSlider9 blockSlider9">
                    <img src="img/banners/коралина2.jpg" alt="" class="imgSlider9">
                    <img src="img/banners/коралина3.jpg" alt="" class="imgSlider9">
            ...
            <div class="manga10 manga">
                <div class="slider">
                    <img src="img/banners/Хребты безумия1.jpg" alt="" class="imgSlider10 blockSlider10">
                    <img src="img/banners/Хребты безумия3.jpeg" alt="" class="imgSlider10">
                    <img src="img/banners/Хребты безумия1.jpg" alt="" class="imgSlider10">
                ...
                <!-- <div class="dotBlock">
                    ...
                    <a href="">Хребты безумия</a>
                    <button class="v_korziny">В корзину</button>
            </div>
            <div class="manga11 manga">
                <div class="slider">
                    <img src="img/banners/Перекрёсток ведьм1.jpg" alt="" class="imgSlider11 blockSlider11">
                    <img src="img/banners/Перекрёсток ведьм2.webp" alt="" class="imgSlider11">
                    <img src="img/banners/Перекрёсток ведьм3.jpg" alt="" class="imgSlider11">
                ...
                <!-- <div class="dotBlock">
                    ...
                    <a href="">Перекресток ведьм</a>
                    <button class="v_korziny">В корзину</button>
                </div>
            </div>
            <div class="manga12 manga">
                <div class="slider">
                    <img src="img/banners/Ключи Локков1.jpg" alt="" class="imgSlider12 blockSlider12">
                    <img src="img/banners/Ключи Локков2.jpg" alt="" class="imgSlider12">
                    <img src="img/banners/Ключи Локков3.jpg" alt="" class="imgSlider12">
            ...
            <div class="manga13 manga">
                <div class="slider">
                    <img src="img/banners/Изгой. Книга 11.jpg" alt="" class="imgSlider13 blockSlider13">
                    <img src="img/banners/Изгой. Книга 12.jpg" alt="" class="imgSlider13">
                    <img src="img/banners/Изгой. Книга 13.jpeg" alt="" class="imgSlider13">
            ...
            <div class="manga14 manga">
                <div class="slider">
                    <img src="img/banners/Ведьмы1.jpg" alt="" class="imgSlider14 blockSlider14">
                    <img src="img/banners/Ведьмы2.jpg" alt="" class="imgSlider14">
                    <img src="img/banners/Ведьмы1.jpg alt="" class="imgSlider14">
            ...
            <div class="manga15 manga">
                <div class="slider">
                    <img src="img/banners/Загробная жизнь с Арчи1.jpg" alt="" class="imgSlider15 blockSlider15">
                    <img src="img/banners/Загробная жизнь с Арчи2.jpg" alt="" class="imgSlider15">
                    <img src="img/banners/Загробная жизнь с Арчи3.jpg" alt="" class="imgSlider15">
            ...
            <div class="manga16 manga">
                <div class="slider">
                    <img src="img/banners/БРПД19461.jpg" alt="" class="imgSlider16 blockSlider16">
                    <img src="img/banners/БРПД19462.jpg" alt="" class="imgSlider16">
                    <img src="img/banners/БРПД19463.jpg" alt="" class="imgSlider16">
            ...
            <div class="manga17 manga">
                <div class="slider">
                    <img src="img/banners/История с кладбищем1.jpg" alt="" class="imgSlider17 blockSlider17">
                    <img src="img/banners/История с кладбищем2.jpg" alt="" class="imgSlider17">
                    <img src="img/banners/История с кладбищем1.jpg" alt="" class="imgSlider17">
            ...
            <div class="manga18 manga">
                <div class="slider">
                    <img src="img/banners/Кромвель Стоун1.jpg" alt="" class="imgSlider18 blockSlider18">
                    <img src="img/banners/Кромвель Стоун2.jpg" alt="" class="imgSlider18">
                    <img src="img/banners/Кромвель Стоун3.jpg" alt="" class="imgSlider18">
            ...
            <div class="manga19 manga">
                <div class="slider">
                    <img src="img/banners/Коралина1.jpg" alt="" class="imgSlider19 blockSlider19">
                    <img src="img/banners/коралина2.jpg" alt="" class="imgSlider19">
                    <img src="img/banners/коралина3.jpg" alt="" class="imgSlider19">
            ...
            <div class="manga20 manga">
                <div class="slider">
                    <img src="img/banners/Хребты безумия1.jpg" alt="" class="imgSlider20 blockSlider20">
                    <img src="img/banners/Хребты безумия3.jpeg" alt="" class="imgSlider20">
                    <img src="img/banners/Хребты безумия1.jpg" alt="" class="imgSlider20">
    ...
    <script src="js/merchprice.js"></script>
</body>
